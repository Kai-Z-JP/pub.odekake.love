...
export type NotesReactionsRankingRequest = operations['notes___reactions-ranking']['requestBody']['content']['application/json'];
export type NotesReactionsRankingResponse = operations['notes___reactions-ranking']['responses']['200']['content']['application/json'];
